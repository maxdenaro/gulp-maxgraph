...
9. [Типограф](#типограф)
10. [Рекомендуемые плагины VS Code](#рекомендуемые-плагины-для-vs-code)
11. [Локальные сниппеты](#локальные-сниппеты)
...
Также в сборку будут добавляться js-сниппетами, тоже тесно связанные с html-сниппетами.
